...
if args.i == None:
    show_command_run = raw_input('What command would you like to run?: \nExample: show version\n:')
elif len(args.i) >= 0:
    show_command_run = open(args.i).readline()
else:
...
def worker_show_cmd(a_device, mp_queue):
    ...
    try:
        ...
        show_cmd = net_connect.send_command_expect(show_command,delay_factor=0.3)
